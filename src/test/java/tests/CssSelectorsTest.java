...
public class CssSelectorsTest {
    ...
    public void cssSelectorsTest() {
        driver.get("C:\\Users\\Valera\\QA18\\TAF\\src\\test\\resources\\index.html");
        ...
        //Поиск по tag name и значению из аттрибута class
        ...
        //Поиск всех элементов, у которых присутствует атрибут title
